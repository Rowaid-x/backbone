    ...
    return Scaffold(
      ...
      body: async.when(
        ...
        data: (notes) {
          if (notes.isEmpty) {
            return const Center(
              child: Text('No alerts', style: TextStyle(color: Colors.white38)),
            );
          }
          return ListView.separated(
            ...
            itemBuilder: (_, i) => _NotificationTile(note: notes[i], onRead: () async {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: note.read ? Colors.white10 : const Color(0xFF00C2FF).withOpacity(0.3),
        ),
      ),
      child: Row(
        ...
        children: [
          Icon(
            ...
            color: note.read ? Colors.white24 : const Color(0xFF00C2FF),
            size: 20,
          ),
            ...
            child: Column(
              ...
              children: [
                Text(
                  note.title,
                  style: TextStyle(
                    color: note.read ? Colors.white54 : Colors.white,
                ...
                Text(
                  DateFormat('MMM d, HH:mm').format(note.createdAt.toLocal()),
